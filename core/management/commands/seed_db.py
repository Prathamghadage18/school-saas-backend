...
from tenants.models import SchoolTenant, SchoolDomain
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(f'  ✓ HQ Admin: hq_admin / testpass123')

        # For each school, create principal, teachers, students, parents
        for school in schools:
            ...
            # Create Timetable for first teacher
            if teachers:
            ...
            for first, last, adm_no in students_data:
                ...
                # Create attendance records (20 days, random present/absent)
                ...
                self.stdout.write(
                    f'      ✓ Student: {first} {last} | Parent: parent_{school.subdomain}_{first.lower()} | '
                    f'Attendance: 20 days seeded'
                )
